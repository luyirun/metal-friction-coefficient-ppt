...
$outPath = Join-Path $outDir "slide09_shape3d_trigger_stable.pptx"
...
try {
    ...
    [void](Add-TriggeredEffect $seq1 $frontInitial $frontButtonInitial ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFlip) $true 0.32)
    ...
    [void](Add-WithPreviousEffect $seq1 $backAnalysis ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFadedSwivel) $false 0.38)
    ...
    [void](Add-TriggeredEffect $seq2 $backAnalysis $backButton ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFlip) $true 0.32)
    ...
    [void](Add-WithPreviousEffect $seq2 $frontReturn ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFadedSwivel) $false 0.38)
    ...
    [void](Add-TriggeredEffect $seq3 $frontReturn $frontButtonReturn ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFlip) $true 0.32)
    ...
    [void](Add-WithPreviousEffect $seq3 $backAnalysis ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFadedSwivel) $false 0.38)
