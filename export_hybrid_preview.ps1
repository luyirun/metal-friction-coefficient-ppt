...
$Pptx = Join-Path $Root "outputs\metal_ice_hybrid_high_fidelity_editable.pptx"
$PreviewDir = Join-Path $Root "outputs\metal_ice_hybrid_high_fidelity_editable_preview"
