...
$Pptx = Join-Path $Root "outputs\metal_ice_99fid_with_editable_text_layer.pptx"
$PreviewDir = Join-Path $Root "outputs\metal_ice_99fid_with_editable_text_layer_preview"
