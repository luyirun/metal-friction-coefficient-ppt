...
SRC = ROOT / "outputs" / "metal_ice_full_editable_preview"
OUT = ROOT / "outputs" / "metal_ice_full_editable_preview_sheet.jpg"
...
font = ImageFont.truetype(r"C:\Windows\Fonts\Noto Sans SC Bold (TrueType).otf", 32)
d.text((margin, 24), "可编辑 PPTX 导出预览", font=font, fill=(18, 48, 58))
