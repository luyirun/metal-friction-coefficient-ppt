...
$outPath = Join-Path $outDir "slide09_shape3d_trigger_elegant.pptx"
...
try {
    ...
    [void](Add-WithPreviousEffect $seq1 $backAnalysis ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFade) $false 0.24)
    [void](Add-WithPreviousEffect $seq1 $backAnalysis ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectGrowShrink) $false 0.24)
    ...
    [void](Add-WithPreviousEffect $seq2 $frontReturn ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFade) $false 0.24)
    [void](Add-WithPreviousEffect $seq2 $frontReturn ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectGrowShrink) $false 0.24)
    ...
    [void](Add-WithPreviousEffect $seq3 $backAnalysis ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectFade) $false 0.24)
    [void](Add-WithPreviousEffect $seq3 $backAnalysis ([Microsoft.Office.Interop.PowerPoint.MsoAnimEffect]::msoAnimEffectGrowShrink) $false 0.24)
