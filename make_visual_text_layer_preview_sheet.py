...
PREVIEW_DIR = ROOT / "outputs" / "metal_ice_99fid_with_editable_text_layer_preview"
OUT = ROOT / "outputs" / "metal_ice_99fid_with_editable_text_layer_preview_sheet.jpg"


def slide_no(path: Path) -> int:
    return int(path.stem.replace("幻灯片", ""))
