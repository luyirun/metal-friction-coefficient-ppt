...
SRC = ROOT / "outputs" / "metal_ice_high_fidelity_layered_editable_text_preview"
OUT = ROOT / "outputs" / "metal_ice_high_fidelity_layered_editable_text_preview_sheet.jpg"
...
d.text((margin, 24), "高保真分层+可编辑文本 PPTX 预览", font=font, fill=(18, 48, 58))
